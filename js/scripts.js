$(document).ready(function() {
  $(".card.js").click(function() {
    $(".card.js.card-front").slideToggle();
    $(".card.js.card-back").slideToggle();

  });
});

$(document).ready(function() {
  $(".card.op").click(function() {
    $(".card.op.card-front").slideToggle();
    $(".card.op.card-back").slideToggle();

  });
});

$(document).ready(function() {
  $(".card.vb").click(function() {
    $(".card.vb.card-front").slideToggle();
    $(".card.vb.card-back").slideToggle();
  });
});

$(document).ready(function() {
  $(".card.vn").click(function() {
    $(".card.vn.card-front").slideToggle();
